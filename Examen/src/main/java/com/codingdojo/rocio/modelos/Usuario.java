...
public class Usuario {
	...
	@Email(message="Ingresa un correo válido")//verifica que sea un email valido
	...
	@Transient//no me guarda l dato en la BD
	@NotEmpty(message="El campo de password es obligatorio")
	@Size(min=8, message="La contraseña debe tener al menos 8 caracteres.")
	...
	private List<Tarea> misTareas; //lista de las tareas que cree
